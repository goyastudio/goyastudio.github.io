---
layout: page
title: AI-Driven MCCB Design System
description: Generative AI-based design optimization for LS ELECTRIC molded case circuit breakers
img: assets/img/lse.png
importance: 1
category: work
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/lse.png" title="LS ELECTRIC MCCB AI Design Project" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
**Source**: [현대경제신문 기사](https://www.finomy.com/news/articleView.html?idxno=247312)
